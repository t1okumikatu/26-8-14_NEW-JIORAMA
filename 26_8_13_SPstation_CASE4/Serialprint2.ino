 ...
 unsigned long nowTime = millis(); 
  ...
  Serial.println("~~~~~~~~~~~~~~~~~");
  Serial.print("Train1Flag21 ==  ");
  Serial.println(Train1Flag21); 
  Serial.print(("Train1sesor21Flag1 ==>Train1sesor31Flag1 =="));
  Serial.print(Train1sesor21Flag1);
  Serial.println(Train1sesor31Flag1); 
  Serial.println("~~~~~~~~~~~~~~~~~");
